...
public class MAuthRequest
{
    ...
    @JsonProperty(value = "callbacksInput3")
    private CallbacksInput callbacksInput3;

    @JsonProperty(value = "callbacksValue3")
    private CallbacksValue callbacksValue3;
    ...
    public CallbacksInput getCallbacksInput3() {
        return callbacksInput3;
    }

    public void setCallbacksInput3(CallbacksInput callbacksInput3) {
        this.callbacksInput3 = callbacksInput3;
    }

    public CallbacksValue getCallbacksValue3() {
        return callbacksValue3;
    }

    public void setCallbacksValue3(CallbacksValue callbacksValue3) {
        this.callbacksValue3 = callbacksValue3;
    }
    ...
    public String toString() {
        return "MAuthRequest{" +
                ...
                ", callbacksInput3=" + callbacksInput3 +
                ", callbacksValue3=" + callbacksValue3 +
                '}';
    }
}
